...
public class COED extends javax.swing.JFrame {
    ...
    public void showBooks() {
        try {
            DefaultTableModel det = (DefaultTableModel) coedBooksTable.getModel();
            
            det.setRowCount(0);
            Statement s = db.con.createStatement();
            db.rs = s.executeQuery("SELECT * FROM Coed_Books");
    ...
    private void initComponents() {
        ...
        coedBooksTable = new javax.swing.JTable();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(57, 167, 255), 2), "Borrow COED Books", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Poppins SemiBold", 1, 18), new java.awt.Color(57, 167, 255))); // NOI18N
        ...
        coedBooksTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(coedBooksTable);

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 57, 550, 200));
        ...
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 30, 570, 270));
    ...
    private void borrowBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrowBtnActionPerformed
        ...
        int book_pages = 0;
            ...
            Statement s = db.con.createStatement();
            db.rs = s.executeQuery("SELECT * FROM Coed_Books WHERE Book_ID = '"+book_id+"'");
    ...
    private void searchFldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFldKeyReleased
        DefaultTableModel def = (DefaultTableModel) coedBooksTable.getModel();
        final TableRowSorter<TableModel> sor = new TableRowSorter<>(def);
          
        coedBooksTable.setRowSorter(sor);
    ...
    private javax.swing.JTable coedBooksTable;
