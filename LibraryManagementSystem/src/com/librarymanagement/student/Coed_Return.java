...
public class Coed_Return extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createMatteBorder(2, 0, 0, 0, new Color(57, 167, 255)), "Return COED Books", TitledBorder.CENTER, TitledBorder.TOP, new Font("Poppins Medium", 0, 14), new Color(57, 167, 255))); // NOI18N
        ...
        bookTitle.setBorder(BorderFactory.createTitledBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(57, 167, 255))), "Book Title", TitledBorder.CENTER, TitledBorder.TOP, new Font("Poppins Medium", 0, 14), new Color(57, 167, 255))); // NOI18N
    ...
    private void returnBtnActionPerformed(ActionEvent evt) {//GEN-FIRST:event_returnBtnActionPerformed
        ...
        String course_year = course_yearFld.getText();
            ...
            if(check == 1){
                db.ps = db.con.prepareStatement("INSERT INTO Coed_Books (Book_ID,Book_Title,Book_Author,Book_pages) VALUES(?,?,?,?)");
                db.ps.setLong(1, idR);
                db.ps.setString(2, titleR);
                db.ps.setString(3, authorsR);
                db.ps.setInt(4, pagesR);
