...
public class CM extends javax.swing.JFrame {
    ...
    public void showBooks() {
        try {
            DefaultTableModel det = (DefaultTableModel) cmBooksTable.getModel();
            
            det.setRowCount(0);
            Statement s = db.con.createStatement();
            db.rs = s.executeQuery("SELECT * FROM Chm_Books");
    ...
    private void initComponents() {
        ...
        cmBooksTable = new javax.swing.JTable();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(57, 167, 255), 2), "Borrow CHM Book", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Poppins SemiBold", 1, 18), new java.awt.Color(57, 167, 255))); // NOI18N
        ...
        cmBooksTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(cmBooksTable);

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 59, 546, 202));

        searchFld.setBackground(new java.awt.Color(255, 238, 217));
        searchFld.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        searchFld.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(57, 167, 255)), "Search Books", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Poppins Medium", 0, 12), new java.awt.Color(57, 167, 255))); // NOI18N
        searchFld.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                searchFldKeyReleased(evt);
            }
        });
        jPanel4.add(searchFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(347, 10, 211, -1));
    ...
    private void borrowBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrowBtnActionPerformed
        try {
        long book_id = Long.parseLong(bookIDFld.getText());
        ...
        int book_pages = 0;
            ...
            Statement s = db.con.createStatement();
            db.rs = s.executeQuery("SELECT * FROM Chm_Books WHERE Book_ID = '"+book_id+"'");
            ...
            db.ps = db.con.prepareStatement("DELETE FROM Chm_Books WHERE Book_ID = ?");
            db.ps.setLong(1, book_id);
    ...
    private void searchFldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchFldKeyReleased
        DefaultTableModel def = (DefaultTableModel) cmBooksTable.getModel();
        final TableRowSorter<TableModel> sor = new TableRowSorter<>(def);
          
        cmBooksTable.setRowSorter(sor);
    ...
    private javax.swing.JTable cmBooksTable;
