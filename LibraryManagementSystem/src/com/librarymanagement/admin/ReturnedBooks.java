...
public class ReturnedBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        moveFrame.add(exit, new AbsoluteConstraints(700, 0, -1, -1));

        jPanel1.add(moveFrame, new AbsoluteConstraints(0, 0, 730, 30));
        ...
        returnedTable.setModel(new DefaultTableModel(
            ...
            new String [] {
                "Book ID", "Book Title", "Book Author", "Book Pages", "Student Full Name", "Student ID #", "Course & Year"
            }
        ) {
        ...
        jPanel2.add(jScrollPane1, new AbsoluteConstraints(20, 90, 670, 270));

        jLabel1.setFont(new Font("Poppins SemiBold", 0, 14)); // NOI18N
        jLabel1.setForeground(new Color(23, 107, 135));
        jLabel1.setText("Search :");
        jPanel2.add(jLabel1, new AbsoluteConstraints(410, 40, -1, -1));
        ...
        jPanel2.add(searchFld, new AbsoluteConstraints(480, 30, 210, 40));
        ...
        jPanel2.add(clearBtn, new AbsoluteConstraints(560, 370, 130, 40));

        jPanel1.add(jPanel2, new AbsoluteConstraints(10, 40, 710, 420));

        getContentPane().add(jPanel1, new AbsoluteConstraints(0, 0, 730, 470));

        setSize(new Dimension(729, 470));
