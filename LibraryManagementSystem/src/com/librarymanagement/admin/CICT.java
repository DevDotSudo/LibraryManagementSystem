...
public class CICT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bookIDFld.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(23, 107, 135), 1, true), "Book ID", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Poppins Medium", 0, 14), new java.awt.Color(23, 107, 135))); // NOI18N
        ...
        bookTitleFld.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(23, 107, 135), 1, true), "Book Title", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Poppins Medium", 0, 14), new java.awt.Color(23, 107, 135))); // NOI18N
        ...
        booksList.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        searchFld.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try
        {
            if(book_id.isEmpty() || book_title.isEmpty() || book_author.isEmpty() || book_page.isEmpty()) {
                ...
                db.ps = db.con.prepareStatement("UPDATE Cict_Books SET Book_Title = ?, Book_Author = ?, Book_Pages = ? WHERE Book_ID = ?");
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Invalid input for book pages");
        }
        catch(Exception e)
        {
