...
public class AdminMenu extends javax.swing.JFrame {
    ...
    public void showStudent(){
        ...
        rs = s.executeQuery("SELECT * FROM StudentInfo");
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(56, 56, 56)
                        .addComponent(idFld, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void updateInfoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateInfoBtnActionPerformed
       try
       {
           ...
           ps = con.prepareStatement("UPDATE StudentInfo set firstName = ?,middleName = ?,lastName = ?,contactNum = ?,course = ?,yearAndSection = ? WHERE ID = ?");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        try
        {
            ...
            long contactNum = Long.parseLong(conNum.getText());
            String course = courseTxt1.getText();
            String yearLevel = yearAndSectionTxt.getText();
            int id = Integer.parseInt(idFld.getText());

            ps = con.prepareStatement("INSERT INTO StudentInfo (ID,firstName,middleName,lastName,contactNum,course,yearAndSection)VALUES(?,?,?,?,?,?,?)");
            ps.setString(1, Integer.toString(id));
            ps.setString(2,fname);
            ps.setString(3,mname);
            ps.setString(4,lname);
            ps.setString(5,Long.toString(contactNum));
            ps.setString(6,course);
            ps.setString(7,yearLevel);
