...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Times New Roman Cyr", 1, 36)); // NOI18N
        ...
        backBtn.setForeground(new java.awt.Color(228, 228, 228));
        ...
        userFld.setBackground(new java.awt.Color(228, 228, 228));
        ...
        passFld.setBackground(new java.awt.Color(228, 228, 228));
        ...
        jPanel1.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 370, 260, 40));
        ...
        jPanel1.add(forgotPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 320, 90, 20));
    ...
    public void login() throws Exception{
        ...
        fReader = new FileReader(cred.ADMIN_PATH);
        bReader = new BufferedReader(fReader);
        esc = new Scanner(bReader);

        // GET THE USERNAME AND PASSWORD FROM FILE
        String fileUsername = esc.nextLine().split(": ")[1];
        String filePassword = esc.nextLine().split(": ")[1];
